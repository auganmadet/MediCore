...
if [ "$MODE" = "quick" ]; then
  ...
  snowsql -c medicore -q "
    DELETE FROM MEDICORE_PROD.RAW.RAW_COMMANDES WHERE cdc_operation != 'S';
    DELETE FROM MEDICORE_PROD.RAW.RAW_FACTURES  WHERE cdc_operation != 'S';
    DELETE FROM MEDICORE_PROD.RAW.RAW_ORDERS    WHERE cdc_operation != 'S';
    DELETE FROM MEDICORE_PROD.RAW.RAW_MODSTOCK  WHERE cdc_operation != 'S';
  "
  ...
  snowsql -c medicore -q "
    TRUNCATE TABLE MEDICORE_PROD.RAW.RAW_COMMANDES;
    TRUNCATE TABLE MEDICORE_PROD.RAW.RAW_FACTURES;
    TRUNCATE TABLE MEDICORE_PROD.RAW.RAW_ORDERS;
    TRUNCATE TABLE MEDICORE_PROD.RAW.RAW_MODSTOCK;
    TRUNCATE TABLE MEDICORE_PROD.RAW.RAW_DAYBYDAY;
    TRUNCATE TABLE MEDICORE_PROD.RAW.RAW_EAN13;
    TRUNCATE TABLE MEDICORE_PROD.RAW.RAW_FOURNISSEURS;
    TRUNCATE TABLE MEDICORE_PROD.RAW.RAW_HISTORY;
    TRUNCATE TABLE MEDICORE_PROD.RAW.RAW_LOG;
    TRUNCATE TABLE MEDICORE_PROD.RAW.RAW_LPPR;
    TRUNCATE TABLE MEDICORE_PROD.RAW.RAW_MANQHISTORY;
    TRUNCATE TABLE MEDICORE_PROD.RAW.RAW_MEDIPRIX_FACTURES;
    TRUNCATE TABLE MEDICORE_PROD.RAW.RAW_PHARMACIE;
    TRUNCATE TABLE MEDICORE_PROD.RAW.RAW_PRODUITS;
    TRUNCATE TABLE MEDICORE_PROD.RAW.RAW_PRODUITS_NEGATIFS;
    TRUNCATE TABLE MEDICORE_PROD.RAW.RAW_STOCKHISTORY;
    TRUNCATE TABLE MEDICORE_PROD.RAW.RAW_PHARMACIES;
    TRUNCATE TABLE MEDICORE_PROD.RAW.RAW_PHARMACIES_ERREUR;
  "
